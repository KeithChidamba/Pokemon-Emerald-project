...
public class BattleHandler : MonoBehaviour, IInjectable
{
    ...
    private Dictionary<BattleParticipantKey, BattleParticipant> battleParticipants = new();
    ...
    public BattleParticipant GetParticipant(BattleParticipantKey participantKey)
    {
