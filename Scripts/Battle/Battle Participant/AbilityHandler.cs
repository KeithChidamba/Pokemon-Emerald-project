...
public class AbilityHandler : BattleParticipantModule
{
    ...
    private void RemoveTrap(BattleParticipant thisParticipant)
    {
    ...
    private void NotifyStaticHit(BattleParticipant attacker,StatusEffect status)//status is unused here but is required for method signature
    {
        _moveUsageHandler.OnStatusEffectHit-=NotifyStaticHit; 
