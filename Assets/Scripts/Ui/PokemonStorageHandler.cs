...
public class PokemonStorageHandler : MonoBehaviour,IInjectable
{
    ...
    public List<PcStoragePokemon> nonPartyIcons = new();
    public List<PcPartyPokemon> partyPokemonIcons;
    ...
    private void LoadPCStorageBoxes()
    {
        ...
        {
            var pokemonIcon = boxIconsParent.GetChild(i).gameObject.GetComponent<PcStoragePokemon>();
    ...
    public void SelectNonPartyPokemon(PcStoragePokemon pokemonIcon)
    {
        if (movingPokemon)
        {
    ...
    private void RemoveFromParty(PcPartyPokemon partyPokemon)
    {
        if (_pokemonPartyHandler.Party.Count > 1)
        {
            storagePartyOptionsParent.SetActive(true);
    ...
    private void SendToPC(int boxNumber,PcPartyPokemon partyPokemon)
    {
